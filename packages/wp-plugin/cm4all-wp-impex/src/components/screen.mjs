            ...
            <components.PanelBody opened className="upload-import-form">
              ...
              <components.ToggleControl
                help={
                  cleanupContent
                    ? __(
                        'Clean up existing post, page, block pattern, nav_menu an reusable block items',
                        'cm4all-wp-impex',
                      )
                    : __(
                        'Keep existing post, page, block pattern, nav_menu an reusable block items.',
                        'cm4all-wp-impex',
                      )
                }
              ...
              <components.ToggleControl
                help={
                  cleanupMedia
                    ? __(
                        'Clean up existing media like images and videos (located at WordPress uploads)',
                        'cm4all-wp-impex',
                      )
                    : __('Keep existing items. Media might be partly overwritten by export', 'cm4all-wp-impex')
                }
