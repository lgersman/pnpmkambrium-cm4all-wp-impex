...
const slice = sliceFactory.createSlice('content-exporter', (factory, slice) => {
  ...
  slice.data.posts[0]['wp:post_content'] = '<!-- wp:paragraph --><p>my friend</p><!-- /wp:paragraph -->';
  return slice;
});
```
...
const slice = sliceFactory.createSlice('content-exporter', (factory, slice) => {
  ...
  slice.data.posts[0]['wp:post_content'] = '<!-- wp:paragraph --><p>Hello my my friend</p><!-- /wp:paragraph -->';
  return slice;
});
```
...
const slice = sliceFactory.createSlice('attachment', (factory, slice) => {
  ...
  slice.meta['impex:post-references'] = ['/image/foo.jpg', '../../images/foo.jpg'];
...
```js
await migrate('./my-impex-export', './my-migrated-impex-export', async (slicePath) => {
