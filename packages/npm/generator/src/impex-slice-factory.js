...
export default class ImpexSliceFactory {
  ...
  static #SLICE_TYPE_REGISTRY = (() => {
    ...
    registry['content-exporter'] = (/* ImpexSliceFactory */ factory, callback) => {
      const boilerplate = {
        version: '1.0.0',
        type: 'php',
  ...
  getRegisteredSliceTypes() {
    return [...Object.keys(ImpexSliceFactory.#SLICE_TYPE_REGISTRY), ...Object.keys(this.#sliceTypeRegistry)];
  }
