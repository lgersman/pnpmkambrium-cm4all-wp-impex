...
test('ImpexSliceFactory: custom slice type', (t) => {
  ...
  sliceFactory.registerSliceType('custom-impex-export-provider-type', (factory, callback) => {
    const boilerplate = {
      version: '1.0.0',
      type: 'php',
  ...
  const slice = sliceFactory.createSlice('custom-impex-export-provider-type', (factory, slice) => {
